...
#$ -tc 100
#$ -j n
#$ -e /home/thattai/kritikak/Param_Brahma_IISERP/Mk_array_job/4c13e/err/Err_\$TASK_ID
#$ -o /home/thattai/kritikak/Param_Brahma_IISERP/Mk_array_job/4c13e/out/Res_\$TASK_ID
####$ -l qname=array-job
